...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x1d0a620eab49a9b6, ; from name: aot-lab6.App(Miftiev)
		i64 u0xe5cf55c5627d2b4e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-lab6.App(Miftiev).dll.so
		ptr null; void* handle
	}, ; 87
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x5ddfa6752225d4f8, ; from name: aot-lab6.App(Miftiev).dll.so
		i64 u0xe5cf55c5627d2b4e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-lab6.App(Miftiev).dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x62bfabfd6a28f7b8, ; from name: aot-lab6.App(Miftiev).so
		i64 u0xe5cf55c5627d2b4e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-lab6.App(Miftiev).dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x65d1be2edff17f31, ; from name: libaot-lab6.App(Miftiev).so
		i64 u0xe5cf55c5627d2b4e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-lab6.App(Miftiev).dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x71ff3cc18534cef7, ; from name: libaot-lab6.App(Miftiev)
		i64 u0xe5cf55c5627d2b4e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-lab6.App(Miftiev).dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x83c4f4367a710d4a, ; from name: lab6.App(Miftiev).so
		i64 u0xe5cf55c5627d2b4e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-lab6.App(Miftiev).dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdc0553d880f9e58f, ; from name: lab6.App(Miftiev)
		i64 u0xe5cf55c5627d2b4e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-lab6.App(Miftiev).dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe5cf55c5627d2b4e, ; from name: libaot-lab6.App(Miftiev).dll.so
		i64 u0xe5cf55c5627d2b4e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-lab6.App(Miftiev).dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf814648bb49f4778, ; from name: lab6.App(Miftiev).dll.so
		i64 u0xe5cf55c5627d2b4e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-lab6.App(Miftiev).dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.lab6.appmiftiev\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [32 x i8] c"libaot-lab6.App(Miftiev).dll.so\00", align 16
